...
3. 如果涉及网页抓取，优先使用集中式网页抓取服务。服务地址从 `WEB_FETCH_BASE_URL` 环境变量读取，API Key 从 `WEB_FETCH_API_KEY` 环境变量或部署平台凭据库读取，禁止写入代码和 Git。接口用法参照 [web_fetch README](https://github.com/yuan-xin-9997/web_fetch/blob/main/README.md)。
